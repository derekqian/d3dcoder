//=============================================================================
// Clip Pixel.cpp by Frank Luna (C) 2008 All Rights Reserved.
//
// Demonstrates the HLSL clip function to draw a wire fence box.
//
// Controls:
//		'A'/'D'/'W'/'S' - Rotate 
//              'Z'/'X' - Zoom
...
class ClipPixelApp : public D3DApp
{
public:
...
void ClipPixelApp::buildVertexLayouts()
{
