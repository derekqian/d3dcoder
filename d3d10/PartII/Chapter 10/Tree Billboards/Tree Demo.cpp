//=============================================================================
// TreeDemo.cpp by Frank Luna (C) 2008 All Rights Reserved.
//
// Demonstrates how to render y-axis aligned tree billboards 
...
TreeApp::TreeApp(HINSTANCE hInstance)
...
void TreeApp::initApp()
{
	...
	for(UINT i = 0; i < 16; ++i)
	{
		...
		float z = RandF(-35.0f, 35.0f);
		float y = mLand.getHeight(x,z);
...
void TreeApp::updateScene(float dt)
{
...
void TreeApp::buildFX()
{
	...
	HRESULT hr = 0;
	hr = D3DX10CreateEffectFromFile(L"clip.fx", 0, 0, 
...
void TreeApp::buildVertexLayouts()
{
